...
const DEMO_ROUTES = [
  {
    start: [40.8075, -73.9640],
    end: [40.8095, -73.9610],
    color: '#22c55e'
  },
  {
    start: [40.8065, -73.9626],
    end: [40.8075, -73.9600],
    color: '#22c55e'
  }
];
...
export function MapView() {
  ...
  useEffect(() => {
    ...
    DEMO_ROUTES.forEach((route) => {
      // Add markers
      L.marker(route.start as L.LatLngExpression).addTo(mapRef.current!);
      L.marker(route.end as L.LatLngExpression).addTo(mapRef.current!);
